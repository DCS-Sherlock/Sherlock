# Sherlock  [![Build Status: APITestCreation](https://travis-ci.org/DCS-Sherlock/Sherlock.svg?branch=APITestCreation)](https://travis-ci.org/DCS-Sherlock/Sherlock?branch=APITestCreation)
