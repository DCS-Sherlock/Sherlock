package uk.ac.warwick.dcs.sherlock.module.model.base.utils;
...
public class TestFirstJavaFile implements TestJavaFile {
	...
	public List<String> CommentExtractor() {
		return new ArrayList<>(Arrays.asList("//comment"));
	}

	@Override
	public List<String> CommentRemover() {
		return new ArrayList<>(Arrays.asList("public", "  ", "class", " ", "{", "}"));
	}
	...
	public List<String> StandardStringifier() {
		return new ArrayList<>(Arrays.asList("//comment", "public  class {}"));
	}

	@Override
	public List<String> StandardTokeniser() {
		return new ArrayList<>(Arrays.asList("LINE_COMMENT", "PUBLIC CLASS LBRACE RBRACE"));
	}
