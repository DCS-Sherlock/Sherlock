...
this is to replace the current version of LegecyDetectionType and let users add their own reasons somehow.
I won't make it final until everything is in place

Now instead of storing a LegecyDetectionType enum, store a string which is the name of the reason?
alternative: LegecyDetectionType is a single reason, and theres another class to store all of them?
*/
/*
public class LegecyDetectionType {
	/**
	...
	public LegecyDetectionType(List<String> extraReasonNames, List<String> extraReasonDescriptions, List<Float> extraReasonWeights) {
		reasons = new HashMap<>();
