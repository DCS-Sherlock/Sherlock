...
public class SettingProfile {
	...
	/**
	 * The default profile settings for each possible setting, i.e. Original, No Whitespace etc. Each array item is itself an array, with the ordering as follows:
	 * <p>
	 * String description String Output directory String Tokeniser Name Boolean inUse Boolean if output directory has been set
	 * <p>
	 * <p>
	 * <p>
	 * int minStringLength int minRunLength int maxForwardJump int maxBackwardJump int maxJumpDiff boolean amalgamate boolean concatanate int strictness
	 */
