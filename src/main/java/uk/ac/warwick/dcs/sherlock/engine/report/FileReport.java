...
public class FileReport {
	...
	/** The main text of the report. Each element in the list should be a separate component e.g. the first item describes
	 *  one similarity, the second item describes, the next, etc.
	 */
