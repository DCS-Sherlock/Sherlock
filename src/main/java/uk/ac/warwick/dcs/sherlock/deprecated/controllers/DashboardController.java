...
import uk.ac.warwick.dcs.sherlock.deprecated.services.detection.DetectionHandler;
import uk.ac.warwick.dcs.sherlock.deprecated.services.detection.MyEdge;
import uk.ac.warwick.dcs.sherlock.deprecated.services.detection.NGramsStrategy;
...
/**
 * @author Aliyah The controller for the Dashboard scene
 */
public class DashboardController implements Initializable {
	 ...
	 * <p>
	 * Using the setting choices selected by the user, this method will run the specified pre-processing techniques. The setting choices are stored in the Settings and SettingProfile classes.
	 */
	...
	/**
	 * When a session has been loaded, the setting configuration (which may differ from default) must be displayed in the GUIs check-boxes
	 */
